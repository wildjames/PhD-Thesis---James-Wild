...
Figure~\ref{fig:massloss and AML:donor mass vs Mdot fit}\todo{Swap this out for a version with no best-fit lines on.} shows the best fit line for $\dot M(M_{\rm donor})$, and Figure~\ref{fig:massloss and AML:white dwarf mass vs Mdot fit} is the fit for $\dot M(M_{\rm wd})$.
