...
The cameras used were mounted on several telescopes across the decade of observations. The three most commonly used telescopes were the Gran Telescopio de Canarias (GTC) on La Palma (with HiPERCAM), the New Technology Telescope (NTT) in Chil\'e (with ULTRACAM), the Thai National Telescope (TNT) with ULTRASPEC, and prior to \todo{When was ULTRACAM taken off the WHT?}, ULTRACAM was hosted on the William Herschel Telescope (WHT), also on La Palma. 
