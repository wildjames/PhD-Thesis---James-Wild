...
The response of each pixel to photons is similar, but is not exactly equal. Further, the optics of the telescope is not perfect, and throughput can vary across the field of view. These effects mean that \todo{I'm done for the day. Pick back up here.}
