...
For a catalogue of the fits, see Appendix~\ref{appendix:lightcurves}, though an example case of ASASSN-16kr is shown in Figure~\ref{fig:three white dwarfs:ASASSN-16kr example lightcurves}.\todo{Tweak the script that generates these figures so that they're more appropriate for the thesis. Columnar rather than a grid, wide and narrow with three per page should look good. This chapter comes after the nice systems, so probably wont need this specific figure.}
