...
\todo{K11 plot with all the eclipse modelled systems on it}
\todo{Period excess plot with all the new systems.}
...
To probe for these correlations, the $\chi^2$ test is insufficient, as both axes have significant errors.
