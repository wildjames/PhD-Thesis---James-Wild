...
\todo{Talking about MH seems pointless. I dont use it - so cut that chunk.}
...
\todo{check this makes sense}A useful aspect of the sampling algorithm is the ability to parallelise the proposal of new steps in every chain \textit{simultaneously}, significantly improving computation time.
