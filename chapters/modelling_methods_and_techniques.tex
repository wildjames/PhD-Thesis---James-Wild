...
When running a parallel tempered MCMC, the values used in the software are $\beta = 1/T$, for which I choose between 3 and 5 evenly spaced values of $\beta$ between 0 and 1.
