...
\todo{I'm not sure happy with these fits - I think they could be improved a bit. I'm doing some blackhole MCMC, and I'll write this when it's done. Should be done by Friday.}
...
There is a large scatter in the observations, but new data continue to lie systematically to the right of the `standard' model track, and the need for extra AML continues to be supported by observations.
...
% \todo{I can re-do this with MESA, but I really don't think it's worth bothering...}
