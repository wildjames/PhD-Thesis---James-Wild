...
%\hypersetup{
	pdfauthor={J. F. Wild},
	pdftitle={James Wild PhD Thesis, 2022},
%	pdfkeywords={},
	breaklinks=true,
...
\title{\textsc{How fast do white dwarf accrete their companion stars?}}
\author{J. F. Wild}
...
\textbf{How fast do white dwarfs accrete their low mass companion stars?}\\
\vspace*{2.5cm}
\LARGE
\text{James F. Wild}\\
\vspace{2cm}
...
{\huge After all my time here, I've yet to see any problem, however complicated, which when you looked at it the right way didn't become still more complicated.} % POUL ANDERSON

{\vspace{0.8cm}\Huge \noindent \textbf{\textcolor{sections}{"}}}\\

\end{center}

\rightline{\large --- Poul Anderson}
...
\include{chapters/observations_and_observational_techniques}

\chapter{Modelling techniques and methodology}
\include{chapters/modelling_methods_and_techniques}

\chapter{Three CVs with peculiar white dwarf colours}
\include{chapters/three_white_dwarfs}

\chapter{Eclipse modelling results of 12 CVs}
\include{chapters/eclipse_modelling_of_12_cvs}

\chapter{Inferring mass loss rate from donor properties}
\include{chapters/evolutionary_modelling}
